...
#create a custom user model by importing the User model from userauths app
...
NOTIFICATION_TYPE = (
 ...
 #creating a Doctor model 
class Doctor(models.Model):         
    user = models.OneToOneField(userauths_models.User, on_delete=models.CASCADE)  # Connect Doctor with User
